...
The organization module (`normpic/manager/photo_manager.py`) implements the core photo ordering and organization workflow for NormPic. It ensures photos are arranged chronologically while preserving burst sequences from individual cameras.
