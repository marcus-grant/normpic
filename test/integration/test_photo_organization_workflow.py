...
class TestPhotoOrganizationWorkflow:
    ...
    def test_mixed_cameras_temporal_ordering_with_manifest(self, create_photo_with_exif, tmp_path):
        ...
        expected_order = [
            ...
            ("wedding-20241005T143047-d85-0.jpg", nikon_conflict), # 14:30:47 (no subsec, filename DSC < IMG)
            ("wedding-20241005T143047-r5a-0.jpg", canon_late)     # 14:30:47.456 (same timestamp different cameras)
        ]
    ...
    def test_fallback_ordering_without_exif(self, tmp_path):
        ...
        assert filenames == ["photo_a_first.jpg", "photo_m_middle.jpg", "photo_z_last.jpg"]
