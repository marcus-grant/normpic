...
class TestCLIConfigHandling:
    ...
    def test_cli_loads_default_config_file(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            with patch(
                "lib.model.config.Config.get_default_config_path",
    ...
    def test_dry_run_flag_shows_dry_run_message(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            result = runner.invoke(
                main, ["--config", str(config_path), "--dry-run", "--verbose"]
            )
...
class TestCLIIntegrationWithPhotoManager:
    ...
    def test_cli_processes_photos_successfully(self):
        ...
        with TemporaryDirectory() as temp_dir:
            ...
            assert (
                "0 warnings" in result.output
            )  # TODO: Update when warnings are implemented
            assert (
                "0 errors" in result.output
            )  # TODO: Update when errors are implemented
