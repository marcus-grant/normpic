...
class TestExtractExifData:
    ...
    def test_extract_exif_data_invalid_timestamp(self, create_photo_with_exif):
        ...
        photo = create_photo_with_exif(
            "invalid_timestamp.jpg",
            DateTimeOriginal="invalid:timestamp:format"
        )
...
class TestIntegrationBehavior:
    ...
    def test_extract_functions_with_sample_cameras(self, create_photo_with_exif, sample_camera_data):
